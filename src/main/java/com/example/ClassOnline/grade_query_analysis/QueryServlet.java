...
public class QueryServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (userObject instanceof com.example.ClassOnline.Entity.Student) {
            com.example.ClassOnline.Entity.Student student = (com.example.ClassOnline.Entity.Student) userObject;
            role = "student";
            userId = student.getId();
            userName = student.getUsername();
        } else if (userObject instanceof com.example.ClassOnline.Entity.Teacher) {
            com.example.ClassOnline.Entity.Teacher teacher = (com.example.ClassOnline.Entity.Teacher) userObject;
            role = "teacher";
